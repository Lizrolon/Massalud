...
public class OrdenData {
    ...
    public Orden BuscarOrden(int id) {
        ...
        Orden orden = new Orden();
        boolean seEncontroResultado = false; // Bandera para verificar si se encontró algún resultado
        ...
        try {
            ...
            while (rs.next()) {
                seEncontroResultado = true; // Se encontró un resultado
        ...
        if (!seEncontroResultado) {
            JOptionPane.showMessageDialog(null, "No se encontró ninguna orden con el ID especificado.");
            return null; // Puedes devolver null u otro valor indicando que no se encontró ningún resultado
        }*/
    ...
    public void borrarOrdporPres(int idOrden){ 
    ...
    public List<Orden> listarOrdenporAfi(int id){
     ...
     public List<Orden> ordenporfechaes(LocalDate fecha){
        ArrayList<Orden> orden = new ArrayList<>();
      try{
