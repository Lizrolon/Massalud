...
public class AfiliadoData {
   ...
   public void guardarAfiliado(Afiliado afiliado){
    ...
    try {
        ...
        if(num>0){
          ...
          JOptionPane.showMessageDialog(null,"Afiliado agregado con éxito");
   ...
   public Afiliado buscarAfiliado(int id){
      ...
      String sql="SELECT nombre,apellido,dni,telefono,domicilio,activo FROM afiliado WHERE idAfiliado = ?";
