...
public class PanelAfiliado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanelAtras.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, -1, -1));
        ...
        jPanelAtras.add(jTnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 170, 190, -1));

        jLabel4.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 51));
        jLabel4.setText("Apellido:");
        jPanelAtras.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, -1, -1));
        ...
        jPanelAtras.add(jTapellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, 190, 20));

        jLabel5.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 51, 51));
        jLabel5.setText("DNI:");
        jPanelAtras.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, -1, -1));
        ...
        jPanelAtras.add(jTDni, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 190, -1));
        ...
        jTDomicilio.setForeground(new java.awt.Color(204, 204, 204));
        jTDomicilio.setText("Calle12");
        ...
        jPanelAtras.add(jBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 90, 30));
        ...
        jPanelAtras.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 190, 190, 10));

        jSeparator3.setForeground(new java.awt.Color(0, 102, 255));
        jPanelAtras.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 190, 10));

        jSeparator5.setForeground(new java.awt.Color(0, 102, 204));
        jPanelAtras.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 190, 10));
    ...
    private void jTDniMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTDniMousePressed
        ...
        if(jTDomicilio.getText().isEmpty()){
            jTDomicilio.setText("Calle12");
            jTDomicilio.setForeground(Color.gray);
        }
    ...
    private void jTDomicilioMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTDomicilioMousePressed
        // TODO add your handling code here:
         if (jTDomicilio.getText().equals("Calle12")) {
            jTDomicilio.setText("");
            jTDomicilio.setForeground(Color.black);
        }
         if (jTnombre.getText().isEmpty()){
